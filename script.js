...
//     if (!isContain(normal - delivery)) {
//         normal - delivery.classList.add('selected');
//         urgent - delivery.classList.remove('selected');
...
//     if (!isContain(urgent - delivery)) {
//         normal - delivery.classList.remove('selected');
//         urgent - delivery.classList.add('selected');
